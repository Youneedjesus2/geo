...
import { ComparisonData, ComparisonField } from '@/types/audit';
...
export const DiscrepancyDetail: React.FC<DiscrepancyDetailProps> = ({ fields, isLocked, onUpgrade }) => {
  ...
  // Safety check - return null if fields is undefined
  if (!fields) return null;
  
  const mismatches = (Object.values(fields) as ComparisonField[]).filter(f => f && f.status === 'MISMATCH');
